...
<section class="hero-collage">
    <div class="container hero-collage__container position-relative" id="<?php echo esc_attr( $id ); ?>">
        <?php if ( $background ) : ?>
            <div class="hero-collage__container__bg" style="background: <?php echo $backgroundColor; ?>; background: linear-gradient(<?php echo $backgroundGradientAngle; ?>deg,<?php echo $backgroundGradientStart; ?>,<?php echo $backgroundGradientEnd; ?>);">
            </div>
        <?php endif; ?>
        <?php if ( $main_image ) : ?>
