...
if ($background == 'solid') {
    ...
    $background_color = $intro_background_gradient_start;
    $background_gradient_start = $intro_background_gradient_start;
    $background_gradient_end = $intro_background_gradient_end;
    $background_gradient_angle = $intro_background_gradient_angle;
} ?>
...
<section class="standard-form container" id="<?php echo esc_attr( $id ); ?>">
    <div class="row">
        <div class="col-12 col-md-6 col-lg-4 pb-4 pb-md-0">
            <div class="p-6 p-md-8 p-lg-10 h-100 standard-form__content" style="background: <?php echo $background_color; ?>; background: linear-gradient(<?php echo $background_gradient_angle; ?>deg,<?php echo $background_gradient_start; ?>,<?php echo $background_gradient_end; ?>);">
                <?php if ( $header ) : ?>
