    ...
    <div class="container" id="<?php echo $row_id; ?>">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 video__col">
                <?php if ($header) : ?>
                    <div class="mb-0 h2 video__header<?php echo $textColor; ?>">
                        <?php echo $header; ?>
                    </div>
                <?php endif; ?>
                <?php if ($paragraph) : ?>
                    <p class="text-xl-regular my-4<?php echo $textColor; ?>">
                        <?php echo $paragraph; ?>
                    </p>
                <?php endif; ?>
                <?php if ( $primary_cta || $secondary_cta ) : ?>
                    <div class="my-4 my-md-5 d-flex video__buttons">
                        <?php if ( $primary_cta ) : ?>
                ...
                <?php endif; ?>
                <?php if ( $video ) : ?>
                    <div class="video__wrap__thumb object-fit-cover mb-2 position-relative">
                ...
                <?php endif; ?>
                <div class="d-flex video__wrap__details">
                    <?php if ($video_title || $video_time_length) : ?>
                        <div class="d-flex align-items-center">
                            <p class="text-sm-bold mb-0<?php echo $textColor; ?>">
                                <?php echo $video_title; ?>&nbsp;&nbsp;
                            </p>
                            <p class="text-sm-regular mb-0<?php echo $textColor; ?>">
                                |  <?php echo $video_time_length; ?>
                            </p>
                        </div>
                    <?php endif; ?>
                    <?php if ( $video_transcript ) : ?>
                        <a class="button button--<?php echo $buttonColor; ?>" href="<?php echo $video_transcript; ?>" target="_blank" rel="noopener" aria-label="Open video transcript">
                            View Transcript
                        </a>
                    <?php endif; ?>
                </div>
