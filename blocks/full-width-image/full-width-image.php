...
if ($top_inset_color) {
    $styleTop = "background: {$top_inset_color};";
}
if ($bottom_inset_color) {
    $styleBottom = "background: {$bottom_inset_color};";
}
?>
...
<section class="full-width-image position-relative">
    ...
    <div class="full-width-image__bg-img position-relative<?php if ($image_height == 'preset') : ?> object-fit-cover<?php endif; ?> w-100"<?php if ($image_height == 'preset') : ?> style="height: <?php echo $height; ?>px;"<?php endif; ?>>
        ...
        <?php if ($top_inset_color) : ?>
            <div class="full-width-image__inset-top" <?php echo get_block_wrapper_attributes([
                'style' => $styleTop
            ]); ?>>
            </div>
        <?php endif; ?>
        <?php if ($bottom_inset_color) : ?>
            <div class="full-width-image__inset-bottom" <?php echo get_block_wrapper_attributes([
                'style' => $styleBottom
            ]); ?>>
            </div>
        <?php endif; ?>
