...
if ($overlay == 'solid') {
    ...
    $overlayColor = $overlay_gradient_start;
    $overlayGradientStart = $overlay_gradient_start;
    $overlayGradientEnd = $overlay_gradient_end;
    $overlayGradientAngle = $overlay_gradient_angle;
}
?>
...
<section class="hero-default position-relative<?php if ($background == 'solid' || $background == 'gradient' || $background == 'image' || $background == 'video') : ?> hero-default__background<?php endif; ?>" id="<?php echo esc_attr( $id ); ?>">
    ...
    <?php endif; ?>
    <div class="container">
        <div class="row hero-default__content<?php echo $containerAlignment; ?>"<?php if ($background == 'solid' || $background == 'gradient') : ?> style="background: <?php echo $backgroundColor; ?>; background: linear-gradient(<?php echo $backgroundGradientAngle; ?>deg,<?php echo $backgroundGradientStart; ?>,<?php echo $backgroundGradientEnd; ?>);"<?php endif; ?>>
            <?php if ($background == 'image') : ?>
                <div class="hero-default__bg-img overlay object-fit-cover w-100 h-100 p-0">
                    ...
                    <?php endif; ?>
                    <div class="hero-default__bg-img__overlay h-100 w-100 overlay"<?php if ($background == 'image') : ?> style="background: <?php echo $overlayColor; ?>; background: linear-gradient(<?php echo $overlayGradientAngle; ?>deg,<?php echo $overlayGradientStart; ?>,<?php echo $overlayGradientEnd; ?>);"<?php endif; ?>></div>
                </div>
            <?php endif; ?>
            <?php if ($background == 'video') : ?>
                <div class="hero-default__bg-video overlay w-100 h-100 p-0">
                    ...
                    <?php endif; ?>
                    <div class="hero-default__bg-video__overlay h-100 w-100 overlay"<?php if ($background == 'video') : ?> style="background: <?php echo $overlayColor; ?>; background: linear-gradient(<?php echo $overlayGradientAngle; ?>deg,<?php echo $overlayGradientStart; ?>,<?php echo $overlayGradientEnd; ?>);"<?php endif; ?>></div>
                </div>
            <?php endif; ?>
