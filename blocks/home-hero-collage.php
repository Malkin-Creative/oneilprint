    ...
    <div class="container">
        <div class="row home-hero-collage__content background-lightest-silver position-relative px-6 px-lg-14">
            <?php if ( $rectangle_background ) : ?>
                <div class="home-hero-collage__content__bg" style="background: <?php echo $backgroundColor; ?>; background: linear-gradient(<?php echo $backgroundGradientAngle; ?>deg,<?php echo $backgroundGradientStart; ?>,<?php echo $backgroundGradientEnd; ?>);">
                </div>
            <?php endif; ?>
