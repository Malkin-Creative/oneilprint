...
<section class="split-content<?php echo $backgroundColor; echo $blockAlignment; ?>" id="<?php echo esc_attr( $id ); ?>">
    <div class="container">
        <div class="row">
                ...
                <?php if ( $image ) : ?>
                    <div class="split-content__content__image position-relative">
                        ...
                        <?php if ( $tile_background ) : ?>
                            <div class="split-content__content__image__bg" style="background: <?php echo $tileBackgroundColor; ?>; background: linear-gradient(<?php echo $tileBackgroundGradientAngle; ?>deg,<?php echo $tileBackgroundGradientStart; ?>,<?php echo $tileBackgroundGradientEnd; ?>);">
                            </div>
                        <?php endif; ?>
